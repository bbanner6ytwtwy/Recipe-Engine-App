    ...
    async function find() {
        try {
            await axios
                ...
                .catch(e => console.log(e) & setData(["Search Limit Reached, Come Back Tomorrow..."]))
        } catch (e) {
            console.log(e)
        }
    }
            ...
            {data.map((e) => { 
             ...
             <div className="card card-bg-orange rounded-3 pb-2">
                ...
                <div className="card-body px-3">
                    ...
                    <p className="card-text text-center error-message" style={{"font-family": 'Lora'}}>{e.title1}</p>
                </div>
            </div> </Link>
            </div>
             )
